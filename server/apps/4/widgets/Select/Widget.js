...
/**
 * @fileoverview
 * (Custom Widget - {@link module:Select|More info}) Select an area on map, highlighting any elements of a layer in the area. The current data source in Infographics & PickColumns is updated, and all averages / calculations are made on the selected data.
 */
define([
	'dojo/_base/declare',
	'dojo/_base/lang',
	...
	return declare([BaseWidget, _WidgetsInTemplateMixin], {
		...
		_initLayers: function (layerInfoArray) {
			...
			all(this._obtainLayerObjects(layerInfoArray)).then(
				lang.hitch(this, function (layerObjects) {
					array.forEach(
						layerObjects,
						lang.hitch(this, function (layerObject, index) {
							...
							if (layerObject && layerObject.objectIdField && layerObject.geometryType) {
								...
								this.own(
									on(
										item,
										'stateChange',
										lang.hitch(this, function (itemStatus) {
											this.shelter.show();
