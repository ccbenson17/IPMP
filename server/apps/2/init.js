...
(function(argument) {
  ...
  if (!window.isXT && window.location.pathname.indexOf("/apps/webappviewer") > -1 && window.queryObject.edit === "true" && window.queryObject.appid) {
