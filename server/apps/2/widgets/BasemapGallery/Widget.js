...
/**
 * @fileoverview
 * Displays a list of basemaps to load in the main map. (Street, Satellite, Grey Canvas, etc) ({@link module:BasemapGallery|More info})
 */
define([
	'dojo/_base/declare',
