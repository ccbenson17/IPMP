...
define([
  ...
  function (declare, BaseWidget, LocateButton, html, on, lang, jimuUtils, Compass, a11y, WidgetManager, PanelManager) {
    var clazz = declare([BaseWidget], {
      ...
      onLocationClick: function (evt) {
        ...
        //var widConf = this._getWidgetConfig('Splash', false);

        // var headWidget = WidgetManager.getInstance().getControllerWidgets()[0];
